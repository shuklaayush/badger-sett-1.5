...
def test_withdrawal_fees_are_issued_as_shares(setup_share_math, deployer, governance, vault, strategy, want, withdrawalFee):
    ...
    expected_shares = expected_fee_in_want * total_supply_before_deposit / vault_balance_before_withdraw
